...
```{r}
countries <- read_csv('.//data_csv/countries.csv')
continent_map <- read_csv('.//data_csv/continent_map.csv')
continents <- read_csv('.//data_csv/continents.csv')
per_capita <- read_csv('.//data_csv/per_capita.csv')
```
...
```{sql, connection="con", include=TRUE}
select 
